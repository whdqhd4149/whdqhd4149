# 👋 안녕하세요. 쉽게 포기하지 않고 끝까지 확인하는 이종봉입니다.

비전공자에서 출발했지만, Java와 Spring Boot, Oracle/SQL을 중심으로 기본기를 쌓아가고 있습니다.

화면, 서버, 데이터베이스가 연결되는 흐름을 이해하며 기능을 구현해 왔습니다.

문제를 만났을 때 원인을 단계적으로 좁혀가며, 안정적인 서비스를 구현할 수 있는 개발자로 성장하고자 합니다.
